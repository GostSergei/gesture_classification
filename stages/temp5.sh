...
nohup bash_scripts/cv_work-origin-mpipe.sh  >  cv_work-origin-mpipe.txt  2>&1 &
nohup bash_scripts/cv_work-origin-ntu.sh    >  cv_work-origin-ntu.txt    2>&1 &
nohup bash_scripts/cv_work-origin-smpl.sh   >  cv_work-origin-smpl.txt   2>&1 &
