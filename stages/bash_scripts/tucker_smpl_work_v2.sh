...
python3 ../bullets/model_work_2.py -s data/skgest-smpl-center_tucker_full.pkl -m models/model4.json -d ./results_2-smpl
python3 ../bullets/model_work_2.py -s data/skgest-smpl-center_tucker_full.pkl -m models/model5.json -d ./results_2-smpl